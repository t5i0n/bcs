      ...
      <div className="container-x grid lg:grid-cols-[0.9fr_1.1fr] gap-14 items-center">
        <div>
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-balance">
            Why Buyers Choose BCS Coffee
          </h2>
          <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
            We combine Ethiopian origin expertise with international trade
            experience so buyers can source coffee with confidence, quality, and
            transparency.
          </p>
            ...
            {[
              {
                ...
                desc: "Every exporter and lot is reviewed through a rigorous verification process.",
              },
              {
                icon: Star,
              ...
              },
              {
                ...
                desc: "We manage compliance, paperwork, and logistics so your shipment arrives smoothly.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        >
          ...
          <p className="mt-6 text-white/90 leading-relaxed">
            ...
            helping importers source the right beans, verify the right
    ...
    <section className="py-24 md:py-32 bg-background">
      <div className="container-x">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-balance">
            Trusted by Roasters, Buyers, and Importers
          </h2>
          <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
            Real partner stories from buyers who source coffee through our
            verified Ethiopian network.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {[
            {
              quote:
                "BCS helped us find the exact Yirgacheffe profile we needed with full exporter traceability.",
              name: "Nora, European roastery owner",
            },
            {
              quote:
                "The verification and shipping support saved us weeks and gave us confidence in every container.",
              name: "Marco, specialty buyer",
            },
            {
              quote:
                "Their market knowledge and network made our first Ethiopian origin purchase feel easy.",
              name: "Leila, coffee importer",
            },
          ].map((item) => (
            <div
              key={item.name}
